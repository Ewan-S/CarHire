...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.userAccountAcquisitionDate = "ai.UserAccount.accountAcquisitionDate";
            this.userAccountId = "ai.UserAccount.accountId";
            this.userAgent = "ai.UserAccount.userAgent";
            this.userId = "ai.UserAccount.id";
            this.userStoreRegion = "ai.UserAccount.storeRegion";
            this.userAuthUserId = "ai.UserAccount.authUserId";
            this.userAnonymousUserAcquisitionDate = "ai.UserAccount.anonUserAcquisitionDate";
            this.userAuthenticatedUserAcquisitionDate = "ai.UserAccount.authUserAcquisitionDate";
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                    ...
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth UserAccount context failed. " + "UserAccount auth/UserAccount id should be of type string, and not contain commas, semi-colons, equal signs, spaces, or vertical-bars.");
                        return;
                    }
        ...
        var AppInsights = (function () {
            ...
            AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth UserAccount context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.clearAuthenticatedUserContext = function () {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Clearing auth UserAccount context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
